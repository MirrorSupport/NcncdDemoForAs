...
public class MainActivity extends AppCompatActivity {
    ...
    /*列表数据*/
    private String[] datas = {"上传血糖数据", "上传健康数据", "上传血压数据", "上传运动数据", "上传睡眠数据", "上传血氧数据", "上传心率数据", "上传体温数据", "上传用户数据界面", "上传视力数据", "上传胆固醇数据", "上传内分泌数据", "上传心脑血管数据", "上传消化系统数据", "上传呼吸系统数据", "上传骨骼系统数据", "上传免疫系统数据", "上传男性生殖系统数据", "上传女性生殖系统数据", "上传营养状态数据", "上传有害物质数据", "上传皮肤系统数据", "上传用户数据"};
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 11://内分泌
                        ...
                        break;
                    case 12://心脑血管
                        CardiovascularApi.uploadCardiovascular(MainActivity.this, "18811427233", cardiovasculars, new ApiHandle() {
                    ...
                    case 16://免疫
                        ...
                        break;
                    case 17://男性生殖系统
                        MaleReproductiveApi.uploadMaleReproductive(MainActivity.this, "18811427233", maleReproductives, new ApiHandle() {
                        ...
                        break;
                    case 18://女性生殖系统
                        FemaleReproductiveApi.uploadFemaleReproductive(MainActivity.this, "18811427233", femaleReproductives, new ApiHandle() {
                    ...
                    case 19://营养状态
                        ...
                        break;
                    case 20://有害物质
                        HarmfulSubstancesApi.uploadHarmfulSubstances(MainActivity.this, "18811427233", harmfulSubstances, new ApiHandle() {
